...
import br.infnet.tp1_guilda.domain.audit.enums.AuditAction;
...
public class AuditEntry {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "auditEntriesIdSeq")
    @SequenceGenerator(
            name = "auditEntriesIdSeq",
